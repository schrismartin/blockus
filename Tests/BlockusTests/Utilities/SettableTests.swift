...
class SettableTests: XCTestCase {
    ...
    static let allTests = [
        ("testSingleValuePropertyIsSet", testSingleValuePropertyIsSet),
        ("testClosurePropertyIsSet", testClosurePropertyIsSet),
        ("testMultipleSetsTriggerDidSetOnce", testMultipleSetsTriggerDidSetOnce)
    ]
